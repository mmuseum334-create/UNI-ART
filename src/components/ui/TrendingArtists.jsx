    ...
    <section className="py-20 bg-white dark:bg-[#0f0f0f] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div
            className="w-full flex-1 min-w-0 ml-0 lg:ml-20 px-5 sm:px-8 py-6 sm:py-8 bg-white/80 dark:bg-[#171717] rounded-lg shadow-[0_0px_20px_rgba(0,0,0,0.1)] dark:shadow-[0_0px_20px_rgba(0,0,0,0.3)]"
            style={{
